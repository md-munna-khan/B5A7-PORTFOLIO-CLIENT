...
export function OrbitingCirclesDemo() {
  ...
  return (
    <div className="relative flex h-[280px] sm:h-[380px] md:h-[480px] lg:h-[580px] xl:h-[600px] w-full items-center justify-center overflow-hidden">
      {/* Outer Orbit */}
      <OrbitingCircles iconSize={40} radius={radius}>
        <Icons.react />
        <Icons.nodejs />
        <Icons.nextjs />
        <Icons.redux />
